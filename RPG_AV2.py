...
O ar se torna rarefeito à medida que você sobe. A trilha, esculpida entre rochas geladas e estreitas, serpenteia entre abismos e penhascos cobertos de neve. 
Rajadas cortantes de vento uivam como lobos famintos, tentando empurrá-lo de volta. Cada passo exige esforço. Seu corpo treme, mas sua vontade se mantém firme.

No meio do caminho, você encontra uma bifurcação com placas cobertas de neve. Uma delas está partida. Um corvo empoleirado te observa.

Você sente que a montanha testa não apenas sua força, mas também sua mente...
    """)
...
def desafio_silencio(vida_atual):
    ...
    você se depara com uma criatura imensa dormindo à frente, um Golem de Lama!
    Você consegue ver que o terreno no qual ele descansa é muito irregular e cheio 
    ...
    Acumule 5 avanços para escapar. Se ruído exceder 5... o monstro irá acordar!
    """)
    ...
    while avancos < 10:
        print(f"\nAvanços: {avancos}/5 | Ruído atual: {ruido}")
